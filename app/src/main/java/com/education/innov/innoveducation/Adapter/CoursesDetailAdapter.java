 ...
 */
public class CoursesDetailAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public CoursesDetailAdapter(Context context) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            View CoursesRow = inflater.inflate(R.layout.row_item_course_detail, parent, false);
